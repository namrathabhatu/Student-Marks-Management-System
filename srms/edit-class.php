...
<html lang="en">
    <head>
        ...
        <title>SMMS Admin Update Class</title>
...
<br>
                                                   <div class="">
                                                           <button type="submit" name="Delete" class="btn btn-success btn-labeled">Delete<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div> 
                                                </form>
