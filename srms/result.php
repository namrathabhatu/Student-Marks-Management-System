                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Student Marks Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
...
foreach($results as $result){
    ...
    ?>
                                                ...
                                                <th scope="row"><?php echo htmlentities($cnt);?></th>
                                                			<td><?php echo htmlentities($subject=$result->SubjectName);?></td>
