...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,RollId=:rollid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob where StudentId=:stid ";
...
{
$rollid=$_POST['rollid']; 
$sql="Delete FROM tblstudents WHERE RollId=:rollid";
$query = $dbh->prepare($sql);
...
<html lang="en">
    <head>
        ...
        <title>SMMS Admin| Edit Student < </title>
...
$sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblstudents.StudentEmail,tblstudents.Gender,tblstudents.DOB,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
