...
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,DOB,ClassId) VALUES(:studentname,:rollid,:studentemail,:gender,:dob,:classid)";
...
<html lang="en">
    <head>
        ...
        <title>SMMS Admin| Student Admission< </title>
